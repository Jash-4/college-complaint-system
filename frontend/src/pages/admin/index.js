...
export default function AdminConsolePage() {
  ...
  // Quick one-click status transition
  const handleQuickStatus = async (complaintId, newStatus) => {
    try {
      const res = await complaintAPI.updateStatus(complaintId, { status: newStatus });
      if (res?.complaint) {
        setComplaints((prev) =>
        ...
        <div className="space-y-8">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
            <div className="flex items-center gap-3">
              <div className="flex h-12 w-12 items-center justify-center rounded-2xl bg-purple-100 text-purple-700 shadow-inner">
            ...
            <button
              ...
              disabled={loading}
              className="flex items-center gap-1.5 rounded-xl border border-slate-200 bg-white px-4 py-2.5 text-xs font-semibold text-slate-700 hover:bg-slate-50 transition-colors shadow-sm self-start sm:self-auto disabled:opacity-50"
            >
            ...
            <div className="flex flex-col md:flex-row items-stretch md:items-center justify-between gap-3">
              ...
              <div className="relative flex-1">
                ...
                <input
                  ...
                  className="w-full rounded-xl border border-slate-300 py-2 pl-10 pr-4 text-xs sm:text-sm text-slate-900 placeholder:text-slate-400 focus:border-purple-600 focus:outline-none focus:ring-2 focus:ring-purple-600/20"
                />
              </div>
              ...
              <select
                ...
                className="rounded-xl border border-slate-300 py-2 px-3 text-xs font-medium text-slate-700 bg-white focus:border-purple-600 focus:outline-none"
              >
          ...
          <div className="overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm">
            ...
            {loading ? (
              ...
              <div className="py-16 text-center text-slate-500">
                ...
                <p className="font-semibold text-slate-700">No complaints matching filters</p>
                <p className="text-xs text-slate-400 mt-1">Try relaxing search terms or filters.</p>
              </div>
            ) : (
                      ...
                      >
                        ...
                        <td className="px-6 py-4 whitespace-nowrap font-medium text-slate-700">
                          {item.assignedTo && item.assignedTo !== 'Unassigned' ? (
                            <span className="inline-flex items-center gap-1 rounded-md bg-purple-50 px-2 py-0.5 text-purple-700 border border-purple-200">
                        ...
                        <td className="px-6 py-4 text-right whitespace-nowrap">
                          <div className="flex items-center justify-end gap-2">
                            <button
                              ...
                              className="flex items-center gap-1 rounded-lg border border-purple-200 bg-purple-50 px-2.5 py-1.5 text-xs font-semibold text-purple-700 hover:bg-purple-100 transition-colors shadow-sm"
                ...
                <form onSubmit={handleModalSave} className="space-y-4">
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    ...
                    <div>
                      ...
                      <select
                        ...
                        className="w-full rounded-xl border border-slate-300 py-2.5 px-3 text-xs font-semibold text-slate-900 bg-white focus:border-purple-600 focus:outline-none"
                      >
                        <option value="Submitted">Submitted</option>
                        <option value="Under Review">Under Review</option>
                        <option value="Assigned">Assigned</option>
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className="w-full rounded-xl border border-slate-300 py-2.5 px-3 text-xs text-slate-900 placeholder:text-slate-400 focus:border-purple-600 focus:outline-none"
                    />
                  </div>
