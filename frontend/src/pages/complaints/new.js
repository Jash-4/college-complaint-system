  ...
  const priorities = [
    {
      ...
      color: 'border-slate-300 hover:border-slate-400 peer-checked:border-slate-600 peer-checked:bg-slate-50',
    },
    {
      value: 'Medium',
      label: 'Medium',
      desc: 'Standard maintenance problem requiring attention',
      color: 'border-blue-200 hover:border-blue-300 peer-checked:border-blue-600 peer-checked:bg-blue-50',
    },
    {
      value: 'High',
      label: 'High',
      desc: 'Disrupts study, academic activities, or living conditions',
      color: 'border-amber-200 hover:border-amber-300 peer-checked:border-amber-600 peer-checked:bg-amber-50',
    },
    {
      value: 'Critical',
      label: 'Critical',
      desc: 'Safety hazard, major outage, or emergency issue',
      color: 'border-rose-200 hover:border-rose-300 peer-checked:border-rose-600 peer-checked:bg-rose-50',
    },
  ];
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <form onSubmit={handleSubmit} className="lg:col-span-2 space-y-6">
              <div className="rounded-3xl border border-slate-200 bg-white p-6 sm:p-8 shadow-sm space-y-5">
                {/* Title */}
                <div>
                  <label htmlFor="title" className="block text-xs font-bold text-slate-800 mb-1.5">
                  ...
                  <input
                    ...
                    className="w-full rounded-xl border border-slate-300 py-2.5 px-3.5 text-sm text-slate-900 placeholder:text-slate-400 focus:border-indigo-600 focus:outline-none focus:ring-2 focus:ring-indigo-600/20"
                  />
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div>
                    <label htmlFor="category" className="block text-xs font-bold text-slate-800 mb-1.5">
                    ...
                    <div className="relative">
                      <select
                        ...
                        onChange={handleChange}
                        className="w-full rounded-xl border border-slate-300 py-2.5 px-3 text-sm text-slate-900 bg-white focus:border-indigo-600 focus:outline-none focus:ring-2 focus:ring-indigo-600/20"
                      >
                        {categories.map((c) => (
                  ...
                  <div>
                    <label htmlFor="location" className="block text-xs font-bold text-slate-800 mb-1.5">
                ...
                <div>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                    {priorities.map((p) => (
                      <label
                        key={p.value}
                        className="relative flex cursor-pointer rounded-2xl border p-3.5 shadow-sm transition-all focus-within:ring-2 focus-within:ring-indigo-500"
                      >
                        <input
                          type="radio"
                          name="priority"
                ...
                {/* Description */}
                <div>
                  <label htmlFor="description" className="block text-xs font-bold text-slate-800 mb-1.5">
                  ...
                  <textarea
                    ...
                    className="w-full rounded-xl border border-slate-300 p-3.5 text-sm text-slate-900 placeholder:text-slate-400 focus:border-indigo-600 focus:outline-none focus:ring-2 focus:ring-indigo-600/20"
                  />
                  <span className="text-[11px] text-slate-400 block mt-1 text-right">
              ...
              <div className="flex items-center justify-end gap-3">
                <Link
                  href="/dashboard"
                  className="rounded-xl border border-slate-200 bg-white px-5 py-3 text-xs font-semibold text-slate-700 hover:bg-slate-50 transition-colors"
                >
                  Cancel
                </Link>
                <button
                  type="submit"
                  disabled={submitting}
                  className="flex items-center gap-2 rounded-xl bg-indigo-600 px-6 py-3 text-xs font-semibold text-white shadow-md shadow-indigo-200 hover:bg-indigo-700 disabled:opacity-60 transition-colors"
                >
                  {submitting ? (
                    <>
            ...
            <div className="space-y-4">
              <div className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
                ...
                <div className="space-y-3">
                  ...
                  <p className="text-xs text-slate-600 line-clamp-4 leading-relaxed border-t border-slate-100 pt-3 break-words">
              ...
              <div className="rounded-2xl border border-indigo-100 bg-indigo-50/60 p-5 text-xs text-indigo-900">
                <p className="font-bold flex items-center gap-1.5 mb-1 text-indigo-700">
